...
> 1. Take a look at your `un-report` directory. 
> You should be able to see it in the bottom right side of your screen under the "Files" tab.
> What folders are there, and why do you think they're there? 
>
> > ## Solution
> > There are lots of different ways to organize files, but you should have some consistent method of organizing them so that it's easy to find what you want.
> > If you have all of your files in one folder, it can get kind of confusing to find what you need. 
> > In the `un-report` directory there are three "sub-directories": `data`, `figures`, and `reports`. 
...
> The tidyverse messages give you more
...
now see a trend in the data. It looks like countries with greater smoking rates tend to have higher lung cancer rates, though it's important to remember that we can't infer causality from this plot alone.
...
1. Then, you have to tell ggplot what specific information from your data you want to plot and how you want that data to show up. 
...
1. Finally, you have to tell ggplot what type of plot you want to make. 
...
> Do we want alpha to go inside our `aes()` function or our `geom_boxplot()`? Why? Test out both and see if you're right! 
> > ## Solution
