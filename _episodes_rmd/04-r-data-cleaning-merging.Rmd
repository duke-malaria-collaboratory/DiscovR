...
> >   count() %>% # this is a shortcut for summarize(n = n())
> >   view()
> > ```
...
> > ```
> > 
> > Notice that we introduced a new function here - `arrange()` - which sorts the column for you. This is to make it easier to compare the different values for each country.
