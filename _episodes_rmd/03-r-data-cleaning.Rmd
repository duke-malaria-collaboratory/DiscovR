...
> How would you clean up your code to avoid overwriting `pollution_2019_clean` as we did above? *Hint: start with the pollution_1990 dataframe.*
> 
> > ## Solution: 
> > ```{r cleancode}
> > 
...
Now that we've learned how clean data, it's time for you to read in and start cleaning your own data and making plots:
